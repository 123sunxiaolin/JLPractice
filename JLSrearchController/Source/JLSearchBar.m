...
@interface JLSearchBar()<UITextFieldDelegate>

@property (nonatomic, strong) UIImageView *backgroundImageView;
@property (nonatomic, strong) JLSearchTextField *searchTextField;
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    self.backgroundColor = JLColor(243, 243, 243, 1.0);
...
- (JLSearchTextField *)searchTextField{
    if (!_searchTextField) {
        _searchTextField = [[JLSearchTextField alloc] initWithFrame:CGRectMake(kScreenWidth * 0.5 - 40, 0, kScreenWidth * 0.5 + 20 - 38, 44)];
...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        [_cancelButton setTitleColor:JLColor(85, 183, 55, 1.0) forState:UIControlStateNormal];
